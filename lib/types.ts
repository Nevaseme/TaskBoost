...
export type Snapshot = { user: Member & {role:string}; members: Member[]; assignments: Assignment[]; submissions: { assignmentId: string; userId: string; updatedAt: string }[]; preferences: Preferences; notifications: AppNotification[] };
